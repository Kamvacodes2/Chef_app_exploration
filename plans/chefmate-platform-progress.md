...
(implementation committed at 1a92d15; push/PR pending).
...
Single next command: push chore/vitest-vite-migration to origin,
then open/merge the PR with a merge commit after CI passes.
```
