...
const INTRO_SOURCES = [
  { src: "Assets/Accompanying Designs/Accompanying Designs/Prepping.png", out: "public/images/intro/prepping.webp" },
  { src: "Assets/Accompanying Designs/Accompanying Designs/Cooking.png", out: "public/images/intro/cooking.webp" },
  { src: "Assets/Accompanying Designs/Accompanying Designs/Garnishing.png", out: "public/images/intro/garnishing.webp" },
  { src: "Assets/Accompanying Designs/Accompanying Designs/Relaxing.png", out: "public/images/intro/relaxing.webp" },
];

const GOAL_TILE_SOURCES = [
  { src: "Assets/Tiles/chefmate-lose-weight-transparent-1024.png", out: "public/images/goals/lose-weight.webp" },
  { src: "Assets/Tiles/chefmate-build-muscle-transparent.png", out: "public/images/goals/build-muscle.webp" },
  { src: "Assets/Tiles/chefmate-anti-inflammatory-transparent.png", out: "public/images/goals/anti-inflammatory.webp" },
  { src: "Assets/Tiles/chefmate-post-partum-transparent.png", out: "public/images/goals/post-partum.webp" },
  { src: "Assets/Tiles/chefmate-mediterranean-transparent.png", out: "public/images/goals/mediterranean.webp" },
  { src: "Assets/Tiles/chefmate-just-good-food-transparent.png", out: "public/images/goals/just-good-food.webp" },
];
...
async function convertBrandLogo() {
  ...
  await sharp(trimmed).resize({ width: 1200, withoutEnlargement: true }).webp({ quality: 90 }).toFile(fullOut);
