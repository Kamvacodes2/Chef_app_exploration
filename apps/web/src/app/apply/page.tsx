...
export default function ApplyLandingPage() {
    ...
    return (
      <>
        <header className="border-b border-[var(--color-oxblood)]/10 bg-white px-6 py-4">
          <Link
            href="/apply"
            className="font-brand text-xl text-[var(--color-oxblood)]"
            onClick={(e) => {
              e.preventDefault();
              setShowForm(false);
            }}
  ...
  return (
    <main className="min-h-screen bg-[var(--color-warm-cream)]">
      ...
      <section className="bg-[var(--color-oxblood)] px-6 py-20 text-white sm:px-8">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <h1 className="mt-4 font-display-wide text-4xl leading-tight sm:text-5xl">
            Cook on your terms. <span className="text-[var(--color-maize)]">Get paid weekly.</span>
          </h1>
          <p className="mx-auto mt-6 max-w-xl text-lg text-white/80">
            Join South Africa&apos;s marketplace for independent chefs. Set your own schedule, cook
            in customers&apos; homes, and earn doing what you love.
          </p>
          <button
      ...
      <section className="px-6 py-20 sm:px-8">
        <div className="mx-auto max-w-3xl text-center">
          <h2 className="font-display-wide text-3xl text-[var(--color-charcoal)]">What you need</h2>
