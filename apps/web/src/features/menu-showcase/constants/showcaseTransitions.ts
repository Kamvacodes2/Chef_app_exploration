...
export const PLATE_BELOW_VARIANTS = Object.freeze({
  ...
  rest: {
    y: "0%",
    opacity: 1,
    transition: { duration: PLATE_ENTER_MS / 1000, ease: EASE_STANDARD },
  },
  exit: {
    y: "-120%",
    opacity: 0,
    transition: { duration: PLATE_EXIT_MS / 1000, ease: EASE_STANDARD },
  },
});
...
export const HANDS_ABOVE_VARIANTS = Object.freeze({
  ...
  pullAway: {
    y: "-115%",
    transition: { duration: PLATE_PULL_AWAY_MS / 1000, ease: EASE_STANDARD },
  },
});
