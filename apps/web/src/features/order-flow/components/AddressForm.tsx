...
function Field({
  ...
  return (
    <div className="flex flex-col gap-1.5">
      <label
        htmlFor={id}
        className="text-xs font-bold uppercase tracking-wider text-[var(--color-bone)]/80"
      >
        {label}
...
export function AddressForm(): ReactElement {
  const { state, setAddressField, setContactField, authenticatedUser, isSessionLoading } =
    useOrder();
