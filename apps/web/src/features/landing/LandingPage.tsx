...
import { CATEGORIES, HOW_IT_WORKS, LANDING_ASSETS, POPULAR_MEALS } from "./content";
    ...
    >
      <Container>
        <div className="mb-7 text-center">
          <h2
            id="how-heading"
            className="font-display text-4xl text-[var(--color-oxblood)] sm:text-5xl"
          >
        ...
        <ol className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          {HOW_IT_WORKS.map((step, index) => (
            <li
              key={step.title}
              className="overflow-hidden rounded-[22px] border border-[var(--color-oxblood)]/12 bg-[var(--color-warm-cream)] shadow-sm"
            >
              ...
              <div className="p-5">
                <h3 className="font-display text-2xl leading-tight text-[var(--color-oxblood)]">
                  {step.title}
                </h3>
                <p className="mt-2 text-sm leading-6 text-[var(--color-charcoal)]/72">
                  {step.body}
                </p>
              </div>
            </li>
...
function KitchenTrustSection(): ReactElement {
  return (
    <section
      id="kitchen-trust"
      className="bg-[var(--color-warm-cream)] py-14 sm:py-18 lg:py-20"
        ...
        <div className="grid gap-5 lg:grid-cols-[0.92fr_1.08fr]">
          <article className="overflow-hidden rounded-[28px] bg-[var(--color-oxblood)] text-white">
            <div className="relative aspect-[4/3]">
              <Image
                src={LANDING_ASSETS.groceryHandoff.src}
                alt={LANDING_ASSETS.groceryHandoff.alt}
                fill
                loading="lazy"
            ...
            <div className="p-7 sm:p-9">
              <h2 id="trust-heading" className="font-display text-4xl leading-tight">
                Turn what you already have into dinner everyone will love.
              </h2>
              <p className="mt-4 leading-7 text-white/78">
                Your Chefmate transforms the groceries in your kitchen into fresh, delicious
                meals—so less food goes to waste and dinner is taken care of.
              </p>
            </div>
          </article>
          <article className="grid overflow-hidden rounded-[28px] border border-[var(--color-oxblood)]/12 bg-[var(--color-warm-white)] lg:grid-cols-[1fr_0.86fr]">
            <div
              className="relative aspect-[4/3] bg-[var(--color-soft-beige)] lg:aspect-auto lg:min-h-[360px]"
              data-testid="kitchen-trust-chef-image"
            >
              <Image
                src={LANDING_ASSETS.chefCooking.src}
                alt={LANDING_ASSETS.chefCooking.alt}
                fill
                loading="lazy"
                sizes="(max-width: 1023px) 100vw, 38vw"
                className="object-cover object-center"
            ...
            <div className="flex flex-col justify-center p-7">
              <h3 className="font-display text-4xl leading-tight text-[var(--color-oxblood)]">
                Real ingredients. Cooked in your kitchen.
              </h3>
              <p className="mt-4 leading-7 text-[var(--color-charcoal)]/75">
                Fresh ingredients, familiar flavours and everyday meals prepared at home by someone
          ...
          {CATEGORIES.map((category) => (
            ...
            >
              ...
              <span className="absolute inset-x-0 bottom-0 p-6 text-white">
                ...
                <span className="mt-2 block max-w-[18rem] text-sm leading-6 text-white/88">
                  {category.body}
                </span>
        ...
        <div className="grid overflow-hidden rounded-[28px] bg-[var(--color-oxblood)] text-white lg:grid-cols-[0.9fr_1.1fr]">
          <div className="flex flex-col justify-center p-8 max-sm:order-2 sm:p-10 lg:p-12">
            ...
            <p className="mt-4 max-w-md leading-7 text-white/78">
              Book a Chefmate chef for everyday cooking in your home.
            </p>
            <div className="mt-7">
              <a
                href="#order-flow"
          ...
          <div className="relative min-h-[300px] max-sm:order-1">
            <Image
              src={LANDING_ASSETS.familyDinner.src}
              alt={LANDING_ASSETS.familyDinner.alt}
              fill
              loading="lazy"
